...
namespace InstaDev_G1_DT.Models
{
    public class Comments : InstaDevBase, IComments
    {
        ...
        public string PrepareLinesCSV(Comments prepareLines){ // aqui será preparado o modo como será armazenado automaticamente as linhas dentro do CSV
        ...
        public void IdGenerator(Comments id){ // esse método gerará números aleatórios de ID
            ...
            }else{ // se não existir mais que zero, o valor do id padrão será zero
                id.IdComment = 0; // 
            }
